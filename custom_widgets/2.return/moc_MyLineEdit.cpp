...
QT_MOC_LITERAL(1, 11, 12), // "returnedText"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "s"
QT_MOC_LITERAL(4, 27, 14) // "returnExtended"

    },
    "MyLineEdit\0returnedText\0\0s\0returnExtended"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnedText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->returnExtended(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::returnedText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::returnedText(const QString & _t1)
{
